...
{  
  ...
  if(millis() - timer >= 5000){
    timer = millis();
    mesh.sendGroup(GROUP_1, "5-G1");
    mesh.sendGroup(GROUP_2, "5-G2");
    mesh.sendName(NAME_ID1, "5-n1");
    mesh.sendName(NAME_ID2, "5-n2");
  }
  delay(10); 
}